...
@Composable
private fun AnimateRaindrop(modifier: Modifier = Modifier, durationMillis: Int = 800) {
...
@Composable
fun AnimateRains(modifier: Modifier = Modifier, lightRain: Boolean = false) {
...
fun PreviewRains() {
    Row {
        Column {
            ...
            AnimateRains(modifier = Modifier.size(150.dp))
        }
        Divider(
            Modifier
                .height(300.dp)
        ...
        Column {
            ...
            Spacer(Modifier.height(5.dp))
            AnimateRains(modifier = Modifier.size(150.dp), lightRain = true)
        }
    }
}
